...
### ---- 
  ...
  load(here::here("RData", "data_bivar_Cexport_fishEff-trawling.RData"))
  
  ### ----- Bivariate data between Cceq and Fishing
  load(here::here("RData", "data_bivar_Tseq_fishEff-trawling.RData"))
  
  ### ----- COCA between Cexport and Fishing
  load(here::here("RData", "data_quantile_0.75_Cexp-trawling.RData"))
  
  ### ----- COCA between Csequestration and Fishing
  load(here::here("RData", "data_quantile_0.75_Tseq-trawling.RData"))
  
  ### ----- Binded data (for panel E)
  load(here::here("RData", "binded.data75.trawling.RData"))
  
  ### ----- Data for the donut plot
  load(here::here("RData", "data_donut75.trawling.RData"))
...
### ---- 
  ...
  ### ----- Panel B
  map_Tseq_FE <- bivariate_map(data_map = data_bivar_Tseq_fishEff, 
                               bivariate_color_scale = bivariate_color_scale,
                               ylab = "Tseq", 
                               xlab = "Fishing",
                               name = NULL)
  ...
  ### ----- Panel D
  map_q75_Tseq <- univariate_map(data_map    = data_quantile_0.75_Tseq,
  ...
  fig <- cowplot::ggdraw() + 
    ...
    cowplot::draw_plot(map_Tseq_FE,   x = 0.42,  y = 0.61, width = 0.60, height = 0.39) +
    cowplot::draw_plot(map_q75_Cexport, x = 0.00,  y = 0.33, width = 0.45, height = 0.29) +
    cowplot::draw_plot(map_q75_Tseq,  x = 0.50,  y = 0.33, width = 0.45, height = 0.29) +
  ...
  ### ----- Save the figure
  ggplot2::ggsave(here::here("Figures", "Figure4.jpeg"), width = 12, height = 10, device = "jpeg", dpi = 600)
